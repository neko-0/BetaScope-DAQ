...
if __name__ == "__main__":
    ...
    argparser.add_argument("-n", "--num_cycle", help="number of cycles", nargs="?", const=1, type=int, dest="numCycle")
    argparser.add_argument("-t1", "--temperature1", help="temperature 1", nargs="?", const=1, type=int, dest="t1")
    argparser.add_argument("-t2", "--temperature2", help="temperature 2", nargs="?", const=1, type=int, dest="t2")
    argparser.add_argument("-w1", "--wait1", help="wait time at temperature 1", nargs="?", const=1,  type=int, dest="w1")
    argparser.add_argument("-w2", "--wait2", help="wait time at temperature 2", nargs="?", const=1, type=int, dest="w2")
    ...
    if argv.test:
        ...
        if argv.numCycle == None or argv.t1 == None or argv.t2==None or argv.w1==None or argv.w2==None:
